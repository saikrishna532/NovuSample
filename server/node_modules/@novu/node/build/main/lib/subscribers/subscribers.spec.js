    ...
    test('should mark all subscriber messages as read', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.post.mockResolvedValue({});
                    return [4, novu.subscribers.markAllMessagesAs('test-action-type-sub', shared_1.MarkMessagesAsEnum.READ)];
                case 1:
                    _a.sent();
                    expect(mockedAxios.post).toHaveBeenCalled();
                    expect(mockedAxios.post).toHaveBeenCalledWith('/subscribers/test-action-type-sub/messages/mark-all', {
                        markAs: shared_1.MarkMessagesAsEnum.READ,
                    });
                    return [2];
            }
        });
    ...
    test('should mark all subscriber messages as read for feed', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.post.mockResolvedValue({});
                    return [4, novu.subscribers.markAllMessagesAs('test-action-type-sub', shared_1.MarkMessagesAsEnum.READ, 'feed-123')];
                case 1:
                    _a.sent();
                    expect(mockedAxios.post).toHaveBeenCalled();
                    expect(mockedAxios.post).toHaveBeenCalledWith('/subscribers/test-action-type-sub/messages/mark-all', {
