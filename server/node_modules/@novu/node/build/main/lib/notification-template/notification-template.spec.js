...
describe('test use of novus node package - NotificationTemplates class', function () {
    ...
    test('should fetch all the notification-templates correctly with limit of 15', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.post.mockResolvedValue({});
                    return [4, novu.notificationTemplates.getAll(0, 15)];
                case 1:
                    _a.sent();
                    expect(mockedAxios.get).toHaveBeenCalled();
                    expect(mockedAxios.get).toHaveBeenCalledWith('/notification-templates', {
